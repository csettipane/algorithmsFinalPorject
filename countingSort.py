...
class SortWin():
    def __init__(self):
        self.win = Tk()
        self.win.title("Counting Sort")  # Set a title
        ...
        self.frame.pack()
        self.label = Label(self.frame, text="Counting Sort")
    ...
    def begin(self):
        self.countingSort.sort()

    def reset(self):
        self.countingSort.reset()

    def show(self):
        self.countingSort = CountingSort(self)
        self.win.mainloop()
